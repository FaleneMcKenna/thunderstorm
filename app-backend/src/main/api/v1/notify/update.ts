...
type Api_NotifyUpdate = ApiWithQuery<'/v1/notify/update', any, QueryParams>

class ServerApi_NotifyUpdate
    extends ServerApi_Get<Api_NotifyUpdate> {
...
module.exports = new ServerApi_NotifyUpdate()
